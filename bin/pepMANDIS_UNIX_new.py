	...
	def parse_user_input(self):
		...
		parser.add_argument('--extra-input',
			help='Use this option if an additional dataset with protein sequences in FASTA AA ' \
				...
				'and exact matching peptides only will be used in downstream analysis. ' \
		...
		parser.add_argument('--offline-blastp',
			help='Perform offline blasting. Provide path to nr database (databasePath) in a config file ' \
			'\'defaults.cfg\'.',
			required=False, action='store_true', default=False
			)
